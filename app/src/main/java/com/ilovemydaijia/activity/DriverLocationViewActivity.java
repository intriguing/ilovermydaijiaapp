                ...
                case 1:
                    ...
                    DriverLocationViewActivity.this.mapView.updateViewLayout(
                            ...
                            new MapView.LayoutParams(-2, -2, this.overlayItem
                                    .getPoint(), 81));
                    DriverLocationViewActivity.this.popDriverStarWarp.removeAllViews();
                    for (int i = 0; i < this.driverInfo.getStarLeave(); i++)
                        DriverLocationViewActivity.this.popDriverStarWarp.addView(createStarView());
                    DriverLocationViewActivity.this.driverPointPopView
